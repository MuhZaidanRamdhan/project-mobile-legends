...
<section class="hero" id="about">
  ...
  <div class="text" data-aos="zoom-in" data-aos-duration="1000">
      Welcome to Website for Mobile Legends Lovers in Indonesia,<br>
      @if (Auth::check())
          {{$user->name}}
      @else
      @endif!
    ...
    <img src="assets/img/icon2.svg" alt="hero-img" style =" width:83%;">
</section>
...
<h3 id="features">Featured Heroes &#11088;</h3>
  ...
  <div class="container mt-5">
    <div class="row align-items-center justify-content-center">
      <div class="col-md-4 text-center" data-aos="zoom-in-right" data-aos-duration="800" id="title-fav">
        ...
        <div class="col-md-8 d-flex justify-content-center items-center gap-3" data-aos="zoom-in-right" data-aos-duration="800">
